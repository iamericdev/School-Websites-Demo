    ...
    <div className="bg-white py-4 px-4 md:px-10 flex flex-col md:flex-row items-center justify-between gap-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-[#e31e24] font-bold text-sm tracking-widest">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex flex-col items-center">
          <div className="text-[#002147] font-black text-2xl tracking-tighter italic border-b-2 border-[#002147]">
            NBA
          </div>
